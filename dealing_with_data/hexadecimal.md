...
<figure><img src="../assets/dealing_with_data/hexadecimal/hex-1.png" alt=""><figcaption></figcaption></figure>

If you have a multiple bytes in you CPU and you want to represent multiple bytes in HEX, we can concatenate them.

<div align="center"><figure><img src="../assets/dealing_with_data/hexadecimal/hex-2.png" alt=""><figcaption></figcaption></figure></div>

We can also use hex to transmit binary data over channels where binary data is inconvenience to transfer.

<div align="right"><figure><img src="../assets/dealing_with_data/hexadecimal/xxd-1.png" alt=""><figcaption></figcaption></figure></div>

<figure><img src="../assets/dealing_with_data/hexadecimal/xxd-2.png" alt=""><figcaption></figcaption></figure>
